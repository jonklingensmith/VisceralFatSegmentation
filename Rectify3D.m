...
Z_T9_T10       = 57;  % middle of T8-T9 vertebra disk slice (use for bottom of thoracic cavity) 
Z_T10_T11       = 46; % top of T4-T5 intervertebral disk slice
upperTop = 110;
...
bellybutton = (length(upperSlices) + lowerTop - UM + 1 - 4):(length(upperSlices) + lowerTop - UM + 1 + 6);
bbx = 52;
